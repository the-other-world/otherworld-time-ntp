...
def get_owst_time():
    now_time = time.time()
    utc_time = datetime.datetime.utcfromtimestamp(now_time)
    ...
    return datetime.datetime(
        ...
        utc_time.month,
        utc_time.day,
        hour, minute, second, millisecond, tzinfo=pytz.UTC
    ).timestamp()
            ...
            if len(rlist) != 0:
                ...
                for temp_socket in rlist:
                    try:
                        ...
                        recv_timestamp = system_to_ntp_time(get_owst_time())
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                send_packet.tx_timestamp = system_to_ntp_time(get_owst_time())
